...
@section('title','Create Edit Author')
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <input type="text" name="name" value="{{ $author->name }}" class="form-control" id="name" placeholder="Name">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <textarea rows="2" cols="" name="description" class="form-control">{{ $author->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <input type="text" name="email" value="{{ $author->email }}" class="form-control" id="email" placeholder="email">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <input type="text" name="address" value="{{ $author->address }}" class="form-control" id="address" placeholder="address">
                                        </div>
                                    </div>
                                </div>
                                   ...
                                   <div class="form-group">
                                       <label for="status" class="control-label">Status</label>
                                        <div class="row pl-4 pr-4">
                                            <div class="col-md-3">
                                                <input type="radio" name="status" value="1" class="form-check-input" id="active" {{ $author->status == 1 ? 'checked':'' }}>
                                                <label class="form-check-label text-success font-weight-bold" for="active">Active</label>
                                            </div>
                                            <div class="col-md-3">
                                                <input type="radio" name="status" value="0" class="form-check-input" id="deactive" {{ $author->status == 0 ? 'checked':'' }}>
