            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form method="POST" action="{{route('admin.publisher.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="name" class="control-label">proprietor_name</label>
                                        <div class="">
                                            <input type="text" name="proprietor_name" class="form-control" id="proprietor_name" placeholder="proprietor_name">
                                        </div>
                                    </div>
                                </div>
